...
export default function ShankyCorporateTrainingPage() {
  ...
  return (    
    ...
    >
      ...
      >
        <div className="relative h-[70vh] min-h-[300px] sm:min-h-[340px] md:h-[70vh] lg:h-[72vh] w-full rounded-xl sm:rounded-2xl overflow-hidden">
      ...
      >
        <div className="relative h-full w-full bg-[var(--background)] rounded-t-xl sm:rounded-t-[2rem] overflow-hidden border-t border-[var(--card-border)]">
          <div className="container mx-auto px-3 sm:px-5 md:px-6 lg:px-8 xl:px-10 py-5 sm:py-8 lg:py-12 xl:py-20 h-full flex items-stretch overflow-hidden">
            <div className="grid md:grid-cols-[1fr_1.25fr] gap-4 sm:gap-6 lg:gap-8 xl:gap-14 items-stretch w-full max-w-[90rem] mx-auto py-4 sm:py-0 pb-10 min-h-0 w-full overflow-y-auto scrollbar-hide">
              {/* Left: Overview + B2B + Value Proposition */}
              <div className="order-2 md:order-1 min-w-0 flex flex-col justify-center">
                <p className="text-[#e63a27] font-semibold text-[10px] sm:text-xs tracking-[0.2em] uppercase mb-1.5 sm:mb-3">
                  Overview
                </p>
                <h2 className="text-xl sm:text-2xl md:text-[2.75rem] lg:text-5xl font-bold leading-[1.2] text-[var(--text-primary)] tracking-tight mb-2 sm:mb-5">
                  Shanky Corporate Training <span className="text-[#e63a27]">Pvt Ltd</span>
                </h2>
                <p className="text-[var(--text-secondary)] text-xs sm:text-sm md:text-lg leading-[1.6] max-w-xl mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="bg-[var(--card-bg)] rounded-xl p-4 sm:p-5 border border-[var(--card-border)]">
                    <h4 className="text-base sm:text-lg font-bold text-[var(--text-primary)] mb-2 sm:mb-3">B2B Services</h4>
                  ...
                  <div className="bg-[var(--card-bg)] rounded-xl p-4 sm:p-5 border border-[var(--card-border)]">
                    <h4 className="text-base sm:text-lg font-bold text-[var(--text-primary)] mb-2 sm:mb-3">Value Proposition</h4>
      ...
      >
        <div className="relative h-full w-full bg-[var(--background)] rounded-t-xl sm:rounded-t-[2rem] overflow-hidden border-t border-[var(--card-border)]">
          ...
          <div className="container relative mx-auto px-3 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-5 sm:py-8 lg:py-12 h-full flex flex-col overflow-y-auto scrollbar-hide max-w-[90rem]">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden mb-5 sm:mb-8 lg:mb-10 border border-[var(--card-border)] shadow-xl shrink-0">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 min-h-[160px] sm:min-h-[200px] lg:min-h-[240px]">
                ...
                <div className="lg:col-span-7 bg-gradient-to-br from-[#e63a27] to-[#c93222] p-4 sm:p-6 md:p-8 flex flex-col justify-center min-h-[120px] sm:min-h-0">
                  <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-white tracking-tight mb-2 sm:mb-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-5 sm:mb-8 lg:mb-10 shrink-0">
              <div className="group bg-[var(--card-bg)] rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-7 border-2 border-[var(--card-border)] hover:border-[#e63a27]/40 transition-all duration-300 shadow-sm hover:shadow-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-5">
                  ...
                  <h3 className="text-base sm:text-xl md:text-2xl font-bold text-[var(--text-primary)]">How We Build Programs</h3>
                </div>
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-gradient-to-br from-[var(--background)] to-[var(--card-bg)] rounded-xl p-3 sm:p-4 md:p-5 shadow-sm">
                    <h4 className="text-sm sm:text-base font-bold text-[var(--text-primary)] mb-1 sm:mb-2">Needs analysis</h4>
                    <p className="text-[var(--text-secondary)] text-xs sm:text-sm leading-relaxed">
                      We align learning objectives to your business goals and audience through structured discovery.
                    </p>
                  </div>
                  <div className="bg-gradient-to-br from-[var(--background)] to-[var(--card-bg)] rounded-xl p-3 sm:p-4 md:p-5 shadow-sm">
                    <h4 className="text-sm sm:text-base font-bold text-[var(--text-primary)] mb-1 sm:mb-2">Competency mapping</h4>
                    <p className="text-[var(--text-secondary)] text-xs sm:text-sm leading-relaxed">
              ...
              <div className="group bg-[var(--card-bg)] rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-7 border-2 border-[var(--card-border)] hover:border-[#e63a27]/40 transition-all duration-300 shadow-sm hover:shadow-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-5">
                  ...
                  <h3 className="text-base sm:text-xl md:text-2xl font-bold text-[var(--text-primary)]">What You Get</h3>
                </div>
            ...
            <div className="rounded-xl sm:rounded-2xl overflow-hidden border-2 border-[var(--card-border)] shadow-lg shrink-0">
              <div className="bg-[var(--card-bg)] px-4 sm:px-6 lg:px-8 py-4 sm:py-5 border-b border-[var(--card-border)]">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[var(--text-primary)]">Why It Matters</h3>
                </div>
              </div>
        ...
        <div className="relative h-full w-full bg-[var(--background)] rounded-t-xl sm:rounded-t-[2rem] overflow-hidden border-t border-[var(--card-border)]">
          <div className="container mx-auto px-3 sm:px-6 md:px-8 lg:px-16 xl:px-20 py-5 sm:py-8 lg:py-12 xl:py-16 h-full flex flex-col overflow-y-auto scrollbar-hide">
            <div className="text-center mb-4 sm:mb-6 lg:mb-12 shrink-0">
              ...
              <h2 className="text-lg sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-[var(--text-primary)] mb-2 sm:mb-3 lg:mb-6 px-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-12 mb-5 sm:mb-8 lg:mb-12">
              ...
              <div className="bg-[var(--card-bg)] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-[var(--card-border)]">
                <div className="flex items-center mb-3 sm:mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#e63a27]">Quality Assurance and Impact Measurement</h3>
                </div>
                <p className="text-[var(--text-primary)] text-sm sm:text-base md:text-lg leading-relaxed">
        ...
        <div className="relative h-full w-full bg-[var(--background)] rounded-t-xl sm:rounded-t-[2rem] overflow-hidden border-t border-[var(--card-border)]">
          <div className="container mx-auto px-3 sm:px-6 md:px-8 lg:px-16 xl:px-20 py-5 sm:py-8 lg:py-12 xl:py-16 h-full flex flex-col overflow-y-auto scrollbar-hide">
            ...
            <div className="space-y-5 sm:space-y-8 lg:space-y-12">
              <div className="bg-[var(--card-bg)] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-[var(--card-border)]">
                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#e63a27] mb-3 sm:mb-4 lg:mb-6 flex items-center flex-wrap gap-2">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#e63a27] rounded-xl flex items-center justify-center shrink-0">
        ...
        <div className="relative h-full w-full bg-[var(--background)] rounded-t-xl sm:rounded-t-[2rem] overflow-hidden border-t border-[var(--card-border)]">
          <div className="container mx-auto px-3 sm:px-6 md:px-8 lg:px-16 xl:px-20 py-5 sm:py-8 lg:py-12 xl:py-16 h-full flex flex-col overflow-y-auto scrollbar-hide">
            ...
            <div className="grid grid-cols-1 min-[400px]:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-5 sm:mb-8 lg:mb-12">
              {[
                ...
                <div key={item.title} className="bg-[var(--card-bg)] rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 border border-[var(--card-border)] hover:border-[#e63a27]/50 transition-all">
                  ...
                  <h4 className="text-sm sm:text-base md:text-lg font-bold text-[var(--text-primary)] mb-0.5 sm:mb-1 md:mb-2">{item.title}</h4>
                  <p className="text-[var(--text-secondary)] text-[11px] sm:text-xs md:text-sm">{item.desc}</p>
                </div>
              ))}
            </div>
            ...
            <div className="text-center mt-auto shrink-0">
              ...
              <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-[var(--text-primary)] mb-3 sm:mb-4 lg:mb-6 leading-tight px-1">
