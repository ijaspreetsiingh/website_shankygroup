  ...
  return (    
    ...
    >
      ...
      <section className="relative w-full pt-3 sm:pt-4 md:pt-6 lg:pt-8 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 pb-8 sm:pb-10 bg-[var(--background)]">
        <div className="relative min-h-[300px] sm:min-h-[360px] h-[58vh] sm:h-[62vh] md:h-[66vh] lg:h-[70vh] xl:h-[72vh] max-w-[1600px] mx-auto w-full rounded-xl sm:rounded-2xl overflow-hidden">
          <div
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-12 sm:py-16 lg:py-20 xl:py-24 max-w-[90rem]">
            <div className="grid md:grid-cols-[1fr_1.25fr] gap-6 sm:gap-8 lg:gap-10 xl:gap-14 items-stretch w-full max-w-[90rem] mx-auto">
              <div className="order-2 md:order-1 min-w-0 flex flex-col justify-center">
                ...
                <h2 className="section-heading text-xl sm:text-2xl md:text-[2.75rem] lg:text-5xl font-bold leading-[1.2] text-[var(--text-primary)] tracking-tight mb-2 sm:mb-5">
