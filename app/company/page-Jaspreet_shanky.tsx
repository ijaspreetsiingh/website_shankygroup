...
const CompanyPage = () => {
  const companies = [
    ...
    },
    {
      ...
      description: 'Infrastructure development, construction, and EPC project execution.',
      image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1200&h=800&fit=crop'
    },
    {
      id: 'shanky-metals-pvt-ltd',
      name: 'Shanky Metals Pvt Ltd',
      shortName: 'Metals Trading',
      category: 'Metals Trading',
      categoryColor: '#64748B',
      description: 'Trading and distribution of ferrous and non-ferrous metals across India.',
      image: 'https://images.unsplash.com/photo-1587293852726-70cdb56c9526?w=1200&h=800&fit=crop'
    },
  ];
