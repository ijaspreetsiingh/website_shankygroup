            ...
            <div className="absolute inset-0 flex flex-col z-30">
              <div className="flex-1 flex items-center px-3 sm:px-6 md:px-10 lg:px-14 xl:px-20 py-6 sm:py-8 md:py-10 lg:py-16">
                <div className="w-full max-w-2xl lg:max-w-3xl text-left">
                  ...
                  <h1 className="text-[28px] min-[380px]:text-[32px] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.1] mb-3 sm:mb-4 lg:mb-5">
      ...
      >
        <div>
          ...
          <div className={`text-center mb-8 sm:mb-12 md:mb-16 transition-all duration-800 ease-out delay-200 ${
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[56px] font-[700] text-[var(--text-primary)] mb-4 sm:mb-6 tracking-[-0.5px] md:tracking-[-1px] leading-[1.15] font-['Montserrat','Arial','sans-serif'] px-1">
          ...
          <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 mb-12 sm:mb-16 md:mb-20">
            ...
            <div className={`transition-all duration-800 ease-out delay-400 ${
              ...
              <h2 className="text-xl sm:text-2xl md:text-[27px] font-[600] text-[var(--text-primary)] mb-4 sm:mb-5 text-center font-['Montserrat','Arial','sans-serif']">
                ABOUT US
              </h2>
...
<br /><br />
          ...
          <div className="mt-8 sm:mt-10 mb-12 sm:mb-16 md:mb-20">
            <div className={`transition-all duration-800 ease-out delay-1200 ${
              ...
              <h2 className="text-2xl sm:text-3xl md:text-[36px] font-[700] text-[var(--text-primary)] mb-6 sm:mb-8 md:mb-12 text-center font-['Montserrat','Arial','sans-serif']">
                CORE VALUES
              </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap justify-center gap-3 sm:gap-4 mb-8 sm:mb-12">
                  <div className="text-center p-4 sm:p-5 md:p-6 bg-[var(--card-bg)] rounded-xl sm:rounded-2xl border border-[var(--card-border)] shadow-[0_20px_40px_rgba(0,0,0,0.1)] transition-all duration-500 hover:shadow-[0_30px_60px_rgba(0,0,0,0.15)] hover:scale-[1.02] sm:hover:scale-105 min-w-0 sm:min-w-[200px] relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="text-sm sm:text-[15px] md:text-[16px] font-[700] text-orange-500 font-['Montserrat','Arial','sans-serif'] leading-relaxed mb-2 sm:mb-3">
                        Integrity
                      </div>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 mb-12 sm:mb-16 md:mb-20">
            <div className={`transition-all duration-800 ease-out delay-1000 ${
              ...
              <h1 className="text-2xl sm:text-3xl md:text-[40px] font-[800] text-[var(--text-primary)] mb-6 sm:mb-8 md:mb-10 text-center font-['Montserrat','Arial','sans-serif'] px-1">
                Our Achievements
              </h1>
