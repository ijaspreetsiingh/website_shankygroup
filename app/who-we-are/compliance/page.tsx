    ...
    >
      ...
      <section className="relative w-full pt-4 md:pt-6 lg:pt-8 px-4 md:px-8 lg:px-12 pb-0 bg-[var(--background)]">
        <div className="relative h-[68vh] md:h-[72vh] lg:h-[75vh] w-full rounded-2xl overflow-hidden shadow-2xl border border-[var(--card-border)]">
          ...
          <div className="absolute inset-0 flex flex-col z-30"><br />
            <div className="flex-1 flex items-center px-4 sm:px-6 md:px-10 lg:px-14 xl:px-20 py-10 lg:py-16">
              <div className="w-full max-w-2xl lg:max-w-3xl text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl max-w-xl text-white/90 leading-relaxed mb-8 lg:mb-10">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-14 md:py-20 lg:py-24 max-w-[90rem]">
        {/* Section 1: Our Commitment – bold split with accent strip */}
        <section
          ref={(el) => { sectionRefs.current.commitment = el; }}
          className={`mb-20 lg:mb-28 transition-all duration-700 ${isVisible('commitment') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
          <div className="relative w-full overflow-hidden rounded-3xl border border-[var(--card-border)] shadow-xl bg-[var(--card-bg)]">
            <div className="grid lg:grid-cols-[1fr_1.1fr] min-h-[480px] sm:min-h-[520px] lg:min-h-[560px]">
              {/* Left: Content + inline stats */}
              <div className="relative flex flex-col justify-center p-8 sm:p-10 lg:p-14 xl:p-16 order-2 lg:order-1">
                <span className="inline-flex items-center gap-3 text-[#e63a27] font-semibold text-base sm:text-lg md:text-xl tracking-[0.15em] uppercase mb-5">
                  <span className="w-10 h-0.5 bg-[#e63a27]" />
                  Our Commitment
                </span>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[2.75rem] xl:text-[3.25rem] font-bold leading-[1.15] text-[var(--text-primary)] tracking-tight mb-5">
                  Integrity at <span className="text-[#e63a27]">Every Level</span>
                </h2>
                <p className="text-[var(--text-secondary)] text-base md:text-lg leading-[1.7] max-w-lg mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <div
                      key={stat.label}
                      className="group flex items-center gap-3 px-4 py-3 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] hover:border-[#e63a27]/40 hover:shadow-md transition-all duration-300"
                    >
                      <span className="text-xl sm:text-2xl font-bold text-[#e63a27] tabular-nums">{stat.value}</span>
                      <span className="text-xs sm:text-sm text-[var(--text-secondary)] font-medium max-w-[120px]">{stat.label}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="relative min-h-[280px] lg:min-h-full order-1 lg:order-2">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 lg:p-10">
                  <blockquote className="text-white text-lg sm:text-xl font-medium leading-relaxed max-w-md">
        ...
        <section
          ...
          className={`mb-20 lg:mb-28 transition-all duration-700 ${isVisible('governance') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
            <div>
              <span className="inline-flex items-center gap-2 text-[#e63a27] font-semibold text-xs sm:text-sm tracking-[0.2em] uppercase mb-3">
                <span className="w-8 h-0.5 bg-[#e63a27]" />
                Corporate Governance
              </span>
              <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold leading-[1.2] text-[var(--text-primary)] tracking-tight">
                Governance & <span className="text-[#e63a27]">Compliance</span>
              </h2>
            </div>
            <p className="text-[var(--text-secondary)] text-base md:text-lg leading-[1.7] max-w-xl lg:text-right">
          ...
          {/* Full-width image strip with caption */}
          <div className="relative rounded-2xl overflow-hidden h-52 sm:h-64 md:h-72 mb-12 border border-[var(--card-border)] shadow-lg">
            <Image
            ...
            <div className="absolute inset-0 flex items-center px-8 md:px-12 lg:px-16">
              <p className="text-white text-lg sm:text-xl md:text-2xl font-medium max-w-2xl">
                Governance practices aligned with global standards—ensuring long-term sustainability and stakeholder confidence.
              </p>
            </div>
          </div>

          {/* Governance Framework – 4 cards with numbers */}
          <h3 className="text-xl font-bold text-[var(--text-primary)] mb-6">Governance Framework</h3>
          <div className="grid sm:grid-cols-2 gap-5 lg:gap-6">
            {[
              ...
              <div
                key={item.title}
                className="group relative bg-[var(--card-bg)] rounded-2xl p-6 sm:p-7 border border-[var(--card-border)] hover:border-[#e63a27]/50 hover:shadow-xl transition-all duration-300 h-full flex flex-col overflow-hidden"
              >
                <span className="absolute top-4 right-4 text-4xl font-black text-[#e63a27]/15 group-hover:text-[#e63a27]/25 transition-colors select-none">{item.num}</span>
                <span className="relative w-12 h-12 rounded-xl bg-[#e63a27]/15 group-hover:bg-[#e63a27]/25 flex items-center justify-center mb-4 transition-colors flex-shrink-0">
                ...
                <h4 className="relative text-[var(--text-primary)] font-bold text-lg mb-2 group-hover:text-[#e63a27] transition-colors">{item.title}</h4>
                <p className="relative text-[var(--text-secondary)] text-sm leading-relaxed flex-1">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section
          ...
          className={`mb-20 lg:mb-28 transition-all duration-700 ${isVisible('policy') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
          <p className="text-[#e63a27] font-semibold text-xs sm:text-sm tracking-[0.2em] uppercase mb-2">
            Policy Framework
          </p>
          <h2 className="text-3xl sm:text-4xl md:text-4xl font-bold text-[var(--text-primary)] mb-8">
            Our Compliance <span className="text-[#e63a27]">Policies</span>
          </h2>
          <div className="relative rounded-2xl overflow-hidden h-48 sm:h-56 md:h-64 mb-12 border border-[var(--card-border)] shadow-lg">
            <Image
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent flex items-center">
              <div className="px-8 md:px-12 lg:px-16 text-white max-w-xl">
                <p className="text-white/90 text-sm md:text-base mb-2">Clear. Documented. Enforced.</p>
                <h3 className="text-2xl md:text-3xl font-bold">Policies that protect our people and our reputation.</h3>
              </div>
            </div>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={item.title}
                className="group bg-[var(--card-bg)] rounded-2xl p-6 border border-[var(--card-border)] hover:border-[#e63a27]/40 hover:shadow-lg transition-all duration-300"
              >
                <div className="w-12 h-12 rounded-xl bg-[#e63a27]/15 group-hover:bg-[#e63a27]/25 flex items-center justify-center mb-4 transition-colors">
                  <svg className="w-6 h-6 text-[#e63a27]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                </div>
                <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2 group-hover:text-[#e63a27] transition-colors">{item.title}</h3>
        ...
        <section
          ...
          className={`mb-20 lg:mb-28 transition-all duration-700 ${isVisible('regulatory') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
          <div className="mb-10">
            <span className="inline-flex items-center gap-2 text-[#e63a27] font-semibold text-sm sm:text-base tracking-[0.2em] uppercase mb-3">
              <span className="w-8 h-0.5 bg-[#e63a27]" />
              Key Areas
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold text-[var(--text-primary)] tracking-tight">
              Regulatory & <span className="text-[#e63a27]">Governance</span>
            </h2>
          </div>

          <div className="rounded-3xl overflow-hidden border border-[var(--card-border)] shadow-xl bg-[var(--card-bg)]">
            <div className="grid lg:grid-cols-2 min-h-0">
              {/* Left: Regulatory Compliance – image + gradient overlay */}
              <div className="relative min-h-[300px] lg:min-h-[380px]">
                ...
                <div className="absolute inset-0 flex flex-col justify-end lg:justify-center p-8 lg:p-10 xl:p-12 text-white">
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3">Regulatory Compliance</h3>
                  <p className="text-white/95 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li key={item} className="flex items-center gap-3 text-white/95 text-sm sm:text-base">
              ...
              {/* Right: Governance & Board */}
              <div className="p-8 lg:p-10 xl:p-12 flex flex-col justify-center">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[var(--text-primary)] mb-4">
                  Governance & Board
                </h3>
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={item.label}
                      className="rounded-xl border border-[var(--card-border)] bg-[var(--card-bg)] p-4 hover:border-[#e63a27]/40 hover:shadow-md transition-all duration-300"
                    >
                      <p className="text-[#e63a27] font-semibold text-sm mb-1">{item.label}</p>
                      <p className="text-[var(--text-secondary)] text-xs leading-snug">{item.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section
          ...
          className={`mb-20 lg:mb-28 transition-all duration-700 ${isVisible('financial') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
        >
          <p className="text-[#e63a27] font-semibold text-xs sm:text-sm tracking-[0.2em] uppercase mb-2">
            Financial Overview
          </p>
          <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold leading-[1.2] text-[var(--text-primary)] tracking-tight mb-6">
            Financial Performance & <span className="text-[#e63a27]">Key Metrics</span>
          </h2>
          <div className="grid lg:grid-cols-12 gap-10 mb-10">
            <div className="lg:col-span-4">
              <p className="text-[var(--text-secondary)] text-base leading-[1.7] mb-6">
                Shanky Group&apos;s financial performance reflects operational excellence, prudent management, and growth-oriented strategy.
              </p>
              <div className="relative rounded-2xl overflow-hidden aspect-[3/4] border border-[var(--card-border)] shadow-lg">
                <Image
            ...
            <div className="lg:col-span-8">
              <h3 className="text-xl font-bold text-[var(--text-primary)] mb-6">Key Financial Highlights</h3>
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={co.name} className="bg-[var(--card-bg)] rounded-2xl border border-[var(--card-border)] overflow-hidden hover:border-[#e63a27]/40 hover:shadow-lg transition-all duration-300">
                    <div className="bg-gradient-to-br from-[#e63a27]/10 to-[#e63a27]/5 px-6 py-4 border-b border-[var(--card-border)]">
                      <h4 className="text-[var(--text-primary)] font-bold text-sm lg:text-base">{co.name}</h4>
                    </div>
                    <div className="p-5 space-y-3">
                      {co.revenue != null && co.revenueLabel != null && (
                        <div>
                          <p className="text-[var(--text-secondary)] text-xs font-medium uppercase tracking-wider">{co.revenueLabel}</p>
                          <p className="text-[#e63a27] font-bold text-lg">{co.revenue}</p>
                        </div>
                      )}
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div>
                          <p className="text-[var(--text-secondary)] text-xs">Authorized Capital</p>
                          <p className="text-[var(--text-primary)] font-semibold">{co.auth}</p>
                        </div>
                        <div>
                          <p className="text-[var(--text-secondary)] text-xs">Paid-up Capital</p>
                          <p className="text-[var(--text-primary)] font-semibold">{co.paid}</p>
                        </div>
                      </div>
                      <p className="text-[var(--text-secondary)] text-xs leading-relaxed pt-1 border-t border-[var(--card-border)]">{co.note}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <p className="text-[var(--text-secondary)] text-sm sm:text-base leading-[1.7] max-w-4xl">
        ...
        >
          <div className="relative rounded-2xl overflow-hidden min-h-[320px] flex items-center justify-center text-center border border-[var(--card-border)] shadow-2xl">
            <Image
            ...
            <div className="relative z-20 px-6 py-14 lg:py-16 max-w-2xl mx-auto">
              <span className="inline-block px-4 py-2 bg-white/20 text-white text-xs font-semibold tracking-wider rounded-full uppercase mb-4 backdrop-blur-sm">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-[#e63a27] hover:bg-white/95 font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-[1.02]"
              >
                Get in Touch
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </Link>
