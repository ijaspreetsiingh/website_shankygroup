...
export const GROUP_OVERVIEW_KNOWLEDGE: KnowledgeEntry[] = [
  {
    keywords: ['shanky group','shanky group kya hai','group ke baare mein','group overview','about shanky','about shanky group','shanky group about','shanky group information','group info','shanky group turnover','shanky group revenue','shanky group annual turnover','shanky group total revenue'],
  ...
  },
  {
    ...
    answer: '📖 **Shanky Group — Hamaari Kahani**\n\n**08/08/2011:** 🔩 Shanky Metals Private Limited established — metal trading begin\n**17/10/2018:** 🌱 Shanky Financial Services Private Limited se shuruaat — chhoti si team, bada sapna\n**30/01/2019:** 📚 Shanky Corporate Training Private Limited — skill development start\n**22/07/2014:** 🏗️ Shanky Buildtech established — construction sector entry\n**05/08/2025:** 🌾 VMS Hub Private Limited launch — food & agriculture sector\n**06/08/2025:** ☀️ Shanky Smart Tech Private Limited launch — solar revolution\n**2015:** 📈 First major banking partnership, 50+ clients\n**2017:** 🌍 International trade begin — Hong Kong market\n**2022:** 🏆 Awards & recognition — national level\n**2023:** 💰 ₹300 Cr+ group turnover milestone\n**2024:** 🚀 7+ entities, 500+ employees, 10,000+ customers\n**2025:** 📈 Individual company growth (Note: These are individual company turnovers, NOT total group turnover):\n• VMS Hub: ₹245 Cr turnover\n• Shanky Metal: ₹14 Cr turnover\n• Shanky Smart Tech: ₹14 Cr turnover\n• Shanky Corporate Training: ₹50 Lakh turnover\n• Shanky Financial Services: ₹26.50 Cr turnover\n• **Total Shanky Group Turnover: ₹300+ Cr (FY 2025-26)**\n\n**Aaj:** Pan-India presence, international clients, growing every day!\n\n"Chhoti shuruaat se badi manzil tak — Shanky Group ki kahaani!" 🌟',
