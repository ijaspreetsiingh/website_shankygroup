...
const GraphyFooter = () => {
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr_1fr_1fr] gap-8 lg:gap-x-5 lg:gap-y-8 pb-8 sm:pb-10 border-b border-[var(--card-border)] items-start">
              ...
              <div className="text-center lg:text-left order-1">
                ...
                <div className="flex justify-center lg:justify-start items-center gap-1.5 flex-wrap">
                  ...
                  <a href="https://www.linkedin.com/company/shankygroup" aria-label="LinkedIn" className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 text-[var(--text-secondary)] hover:text-[#0A66C2] hover:bg-[#0A66C2]/10 transition-all duration-200">
                  ...
                  <a href="https://www.instagram.com/shankygroup?igsh=eTVseG9leGRqcHF6" aria-label="Instagram" className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 text-[var(--text-secondary)] hover:text-[#E4405F] hover:bg-[#E4405F]/10 transition-all duration-200">
      ...
      <style jsx>{`
        /* Footer headings - Same as "Legacy & Leadership" headline (excluding paragraphs) */
        footer h1,
        footer h2,
        footer h3,
        footer h4,
